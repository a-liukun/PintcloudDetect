...
//									}
    ...
    //std::cout<<"======Memory operations took: "<<memTime<<" seconds"<<std::endl;  // 耗时
    //std::cout<<"======Width operation took: "<<widthTime<<" seconds"<<std::endl;
    //std::cout<<"======Width estimation process took: "<<getWTime<<" seconds"<<std::endl;
    //std::cout<<"======Extension took: "<<extendTime<<" seconds"<<std::endl;        //耗时
    //std::cout<<"======Checking took: "<<checkTime<<" seconds"<<std::endl;          //还行
...
void recognition::run(StairVector& output)
{
	...
	//std::cout<<"filter()花费时间: "<<refE-refS<<std::endl;
